...
class StorageTest extends \snb\TestBase
{
  ...
  /**
   * @covers snb\storage\Storage::createFile
   * @covers snb\storage\Storage::__construct
  ...
  /**
   * @covers snb\storage\Storage::addProvider
   * @covers snb\storage\File::__construct
   * @covers snb\storage\File::open
   * @covers snb\storage\File::write
   * @covers snb\storage\File::close
  ...
  /**
   * @covers snb\storage\Storage::removeProvider
   * @covers snb\storage\Storage::addProvider
   * @covers snb\storage\File::__construct
   * @covers snb\storage\File::open
   * @covers snb\storage\File::write
  ...
  /**
   * @covers snb\storage\Storage::put
   */
  ...
  /**
   * @covers snb\storage\Storage::get
   * @covers snb\storage\Storage::put
   * @depends testPut
   */
  ...
  /**
   * @covers snb\storage\Storage::remove
   * @covers snb\storage\Storage::get
   * @covers snb\storage\Storage::put
   * @depends testGet
   */
  ...
  /**
   * @covers snb\storage\Storage::putContents
   */
  ...
  /**
   * @covers snb\storage\Storage::getContents
