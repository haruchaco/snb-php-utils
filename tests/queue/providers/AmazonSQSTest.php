...
require_once DIR_PROJECT.'/libs/queue/providers/AmazonSQS.php';
...
class AmazonSQSTest extends \PHPUnit_Framework_TestCase
{
  ...
  /**
   * @covers snb\queue\providers\AmazonSQS::connect
   * @covers snb\queue\providers\AmazonSQS::offer
   * @covers snb\queue\providers\AmazonSQS::peek
   * @covers snb\queue\providers\AmazonSQS::remove
   */
   ...
   * @covers snb\queue\providers\AmazonSQS::peek
   * @covers snb\queue\providers\AmazonSQS::remove
   * @covers snb\Exception::__construct
  ...
  /**
   * @covers snb\queue\providers\AmazonSQS::connect
   * @covers snb\queue\providers\AmazonSQS::poll
   * @covers snb\queue\providers\AmazonSQS::offer
   * @covers snb\queue\providers\AmazonSQS::peek
   * @covers snb\queue\providers\AmazonSQS::remove
   */
